...
public class TopTwentyThisWeekAdapter extends RecyclerView.Adapter<TopTwentyThisWeekAdapter.ViewHolder> {

    private ObservableArrayList<CustomModelForBandPage> bands;
    private TopChartsViewModel viewModel;

    public TopTwentyThisWeekAdapter(TopChartsViewModel viewModel) {
        ...
        Collections.sort(bands, new Comparator<CustomModelForBandPage>() {
            @Override
            public int compare(CustomModelForBandPage modelForBandPage, CustomModelForBandPage t1) {
                return Double.compare(t1.band.weeklyScore, modelForBandPage.band.weeklyScore);
            }
        });
    }
